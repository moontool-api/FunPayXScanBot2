...
import type { Profile, Product, DbStatus, TelegramLog, ProjectLog, WorkerStatus, ProductView, Campaign, CampaignTemplate, CustomLink, BackgroundExportStatus, TelegramStats, BotUser } from "@/types";
...
export default function FunPayWorkerDashboard() {
  ...
  }, [activeTab, checkScrapingStatus, fetchTelegramLogs, fetchProjectLogs, isSettingsUnlocked, fetchDashboardData, fetchTelegramStats, fetchBgExportStatus, fetchTgBgExportStatus, fetchCampaigns, fetchProductsAndCategories, fetchBotUsers, botUsersPage, botUsersSearchQuery]);
